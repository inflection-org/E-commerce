                ...
                <div>
                  <div className="hidden md:block md:mx-6 mt-5">
                    <ul className="flex justify-between">
                      <li className="font-semibold text-lg">Product Id</li>
                      <li className="font-semibold text-lg">Name</li>
                      <li className="font-semibold text-lg">Price</li>
                      <li className="font-semibold text-lg">Action</li>
                      <li className="font-semibold text-lg">Removed</li>
                    </ul>
                  </div>
                  <WishList />
                </div>
