      ...
      <div class='py-24 relative'>
        <div class='w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto'>
          <div class='w-full'>
            ...
            <div class='grid grid-cols-1 xl:grid-cols-2 gap-11 pb-11 border-b border-gray max-xl:max-w-2xl max-xl:mx-auto'>
              <div class='box flex flex-col gap-y-4 w-full '>
                <div class='flex items-center w-full'>
                  ...
                  <p class='h-2 w-full sm:min-w-[278px] rounded-3xl bg-amber-50 ml-5 mr-3'>
                    <span class='h-full w-[30%] rounded-3xl bg-blue flex'></span>
                  </p>
