...
const Header = () => {
  ...
  return (
    <div className='sticky top-0 z-30 shadow-md'>
      ...
      <div className='hidden md:flex justify-between bg-white px-5 sm:px-10 items-center border-t-2 border-pink'>
        <MenuDropdown />
      ...
      <div
        className={`block md:hidden absolute h-screen w-[60%] bg-white ${
          isOpen
            ? '-translate-x-[0%] md:translate-x-[0%] transition-all ease-in duration-[0.3s]'
            : '-translate-x-[100%] md:translate-x-[0%] transition-all ease-in duration-[0.3s]'
        }`}
      >
        <div className='p-5'>
          {!isLogin && (
